...
export function FooterSection() {
  return (
    <footer id="contact" className="bg-black text-white pt-32 pb-12 px-6 md:px-12 border-t border-white/10 relative overflow-hidden">
      {/* Background glow */}
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-32 gap-12">
          <div className="max-w-3xl">
            <motion.h2 
              ...
              viewport={{ once: true }}
              className="text-5xl md:text-8xl font-light tracking-tighter leading-[1.1] mb-6"
            >
              Ready to <br/>
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <a href="mailto:f.burhama@disruptv.tech" className="group relative flex items-center justify-center w-40 h-40 md:w-48 md:h-48 rounded-full border border-white/20 bg-white/5 backdrop-blur-md hover:bg-white hover:text-black transition-all duration-500">
